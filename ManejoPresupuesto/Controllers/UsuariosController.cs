...
namespace ManejoPresupuesto.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> OlvideMiPassword(OlvideMiPasswordViewModel modelo)
        {
            ...
            if (usuario is null)
            {
                // No hacemos nada si el usuario no existe, para evitar revelar información
                return View();
            }
        ...
        public async Task<IActionResult> RecuperarPassword(RecuperarPasswordViewModel modelo)
        {
            ...
            var resultado = await userManager.ResetPasswordAsync(usuario, modelo.CodigoReseteo,
                modelo.Password);
